...
namespace T2008m.lab.labs4
{
    ...
    {
         public List<KhachHangVN> DanhSach = new List<KhachHangVN>();
                ...
                public override void NhapXuat()
                {
                    ...
                    Console.WriteLine("Ten: "+HoTen1+", ma khach hang: "+MaKh1+", ngay ra hoa don: "+NRHoaDon1+", doi tuong khach hang: "+DoiTuong1+", so luong: "+SoLuong1);
                }
